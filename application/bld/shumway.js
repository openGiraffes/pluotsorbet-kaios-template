        ...
        (function (Profiler) {
            ...
            var TimelineFrame = (function () {
               ...
               */
                ...
                TimelineFrame.prototype.traceStatistics = function (writer, minTime, format) {
                    if (minTime === void 0) { minTime = 0.0001; }
                    if (format === void 0) { format = 0 /* PLAIN */; }
                    ...
                    for (var i = 0; i < s.length; i++) {
                        ...
                        switch (format) {
                            case 0 /* PLAIN */:
                                writer.writeLn((statistic.kind ? statistic.kind.name + ": " : "?: ") +
                ...
                Controller.prototype._createViews = function () {
                    if (this._activeProfile) {
                        ...
                        this._activeProfile.forEachSnapshot(function (snapshot, index) {
                            self._headers.push(new Profiler.FlameChartHeader(self, 1 /* CHART */, snapshot.name));
